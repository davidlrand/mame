...
/***************************************************************************
    ...
    device (src/devices/bus/rs232/s97801.cpp), e.g. on the PC-MX2 SERAD port.  Full RE log:
    97801/RESEARCH-LOG.md.  SS97 host line = 38400 7O1 XON/XOFF.
...
COMP(1983,  s97801, 0,      0,      s97801,  0,     s97801_state, empty_init, "Siemens", "97801 (terminal)", MACHINE_SUPPORTS_SAVE)
